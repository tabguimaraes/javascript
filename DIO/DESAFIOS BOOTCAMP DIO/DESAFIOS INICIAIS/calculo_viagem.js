...
//
let resultado = (horasViagem, velocidadeMedia) => (horasViagem * velocidadeMedia) / 12;
console.log(`${resultado(4, 130).toFixed(3)}`);
console.log(`${resultado(8, 120).toFixed(3)}`);
console.log(`${resultado(3, 110).toFixed(3)}`);
